#
# Module manifest for module 'HyperVBackup'
#
...
RequiredModules = @(@{ModuleName = '7Zip4Powershell'; GUID = 'bd4390dc-a8ad-4bce-8d69-f53ccf8e4163'; ModuleVersion = '1.9.0'; })
...
FunctionsToExport = @('Backup-VM', 'Remove-VMBackup')
